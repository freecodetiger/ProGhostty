...
cp "${ROOT_DIR}/Sources/ProGhosttyApp/Resources/markdown-preview-light.css" "${RESOURCES_DIR}/markdown-preview-light.css"
cp "${ROOT_DIR}/Sources/ProGhosttyApp/Resources/markdown-preview-highlight-theme.css" "${RESOURCES_DIR}/markdown-preview-highlight-theme.css"
cp "${ROOT_DIR}/Sources/ProGhosttyApp/Resources/markdown-preview-highlight.js" "${RESOURCES_DIR}/markdown-preview-highlight.js"
