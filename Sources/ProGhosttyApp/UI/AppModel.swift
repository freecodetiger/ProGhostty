...
final class AppModel: ObservableObject {
  ...
  private lazy var gitBranchTitlebar = GitBranchTitlebarController { [weak self] in
    self?.objectWillChange.send()
  }

  private var effectiveGitBranch: String? {
    gitBranchTitlebar.branch(for: selectedCwd)
  }
  ...
  private func refreshGitBranchInPlace() {
    gitBranchTitlebar.refresh(cwd: selectedCwd)
  }
